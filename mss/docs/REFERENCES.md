...
O modelo deste repositorio nao copia essas arquiteturas grandes. Ele pega os principios mais importantes para um limite pequeno de parametros: hibridismo, atencao barata no gargalo, mascara complexa, campo receptivo dilatado e loss multi-dominio.
